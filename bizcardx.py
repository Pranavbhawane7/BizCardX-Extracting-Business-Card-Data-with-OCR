...
icon = Image.open("C:\\Users\\91888\\Desktop\\bUSINESS_CARD.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By PRANAV BHAWANE",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *PRANAV BHAWANE*!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background:url("https://wallpapers.com/images/high/720p-desktop-pc-background-dvl63pgu3uuv8g79.webp");
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\91888\\Desktop\\bUSINESS_CARD.jpg"), width=500)
        st.markdown("## :white[**Technologies Used :**] Python,easy OCR, Streamlit, SQL, Pandas")
    with col2:
        st.write(
            "## :white[**About :**] Bizcard is a Python application designed to extract information from business cards.")
        st.write(
